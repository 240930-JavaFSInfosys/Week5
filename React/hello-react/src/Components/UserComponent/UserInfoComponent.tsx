...
//It takes props of UserInterface type, so it only accepts UserInterface objects from a parent
export const UserInfoComponent:React.FC<UserInterface> = (user:UserInterface) => {

    /*Destructuring - accomplished with {}
    
    Destructing lets us break up a props object into individual variables
    ...
    useEffect(() => {
        ...
        //Hypothetical GET request, or maybe the bio is already stored in user info
